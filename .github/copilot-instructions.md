...
- Version 0.3.1 on pub.dev exposes ML-KEM and ML-DSA; all 12 SLH-DSA parameter sets (SHAKE and SHA-2 families) are exported only in the development source tree pending the v0.4.0 maintainer release.
...
- All 12 SLH-DSA parameter sets (SHAKE and SHA-2 families, 128s/128f/192s/192f/256s/256f) digital signatures in the development source tree
...
- OpenSSL ML-KEM interoperability harness under tool/openssl_interop
