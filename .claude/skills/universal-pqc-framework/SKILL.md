...
description: Project-level PQC multi-agent framework wrapper for Claude Code. Uses the canonical pqcrypto evidence-scoped manifest and docs for Cryptographic Architect, SecOps, Distinguished Engineer, and Client Integration workflows.
---

# Universal PQC Framework - Claude Code Wrapper

This wrapper is native to the project Claude setup. It is intentionally thin.
