...
description: Project-level PQC multi-agent framework wrapper for Codex. Uses the canonical pqcrypto evidence-scoped manifest and docs for Cryptographic Architect, SecOps, Distinguished Engineer, and Client Integration workflows.
---

# Universal PQC Framework - Codex Wrapper

This wrapper is native to the project Codex setup. It is intentionally thin.
